      ...
      try {
        ...
        if (thumbnailFile) {
          ...
          try {
            ...
            console.log("[NewTestSeriesPage] Thumbnail uploaded:", thumbnailUrl);
          } catch (uploadErr) {
            console.error("[NewTestSeriesPage] Thumbnail upload error:", uploadErr);
            throw new Error(
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            <div className="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
              ...
              >
                {submitting || uploadingThumbnail ? "Creating..." : "Create Test Series"}
              </button>
            </div>
          </form>
        </div>
